...
//echo $output . "\n\n";
  //if ( strpos( $output, 'Author: Travis CI' ) === false ) {  //WHy cron is failing, this line there
    ...
    echo shell_exec( "git remote set-url origin https://$gh_token@github.com/svl-studios/google-fonts.git > /dev/null 2>&1" );
    echo "\n\n";
    //echo shell_exec("git push https://$gh_token@github.com/svl-studios/google-fonts.git --force");
